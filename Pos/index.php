  ...
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="btn btn-danger btn-sm" href="../logout.php" onclick="return confirm('yakin ingin keluar?')">keluar</a>
      </div>
                  ...
                  <?php foreach ($tampil as $row) : ?>
                    <tr>
                      ...
                      <td class='text-center'>
                        <a href='#modal-edit' data-id=<?php echo $row['id']; ?> data-toggle='modal'> <i class='fa fa-pencil-square'>u</i></a>
                        <a href="?hapus=<?php echo $row['id']; ?>" onclick="return confirm('yakin ingin menghapus?')"><i class=' fa fa-trash'></i></a>
                      </td>
                    </tr>
                    <?php $i++; ?>
                  <?php endforeach; ?>
